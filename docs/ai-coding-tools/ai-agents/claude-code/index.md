...
- [Mastering Claude Code in 30 minutes](https://www.youtube.com/watch?v=6eBSHbLKuN0) - Introductory video by Boris Cherny
...
- [Discover and install plugins](https://code.claude.com/docs/en/discover-plugins) - Official guide to plugin marketplaces and installation
- [Create plugins](https://code.claude.com/docs/en/plugins) - Package skills, agents, hooks, and MCP servers for reuse
- [Codex Plugin for Claude Code](https://github.com/openai/codex-plugin-cc) - Use Codex inside Claude Code for reviews and delegated tasks

### Tools And Observability

- [Trace Claude Code](https://docs.langchain.com/langsmith/trace-claude-code) - Trace Claude Code sessions using LangSmith

## Use Cases And Case Studies

- [How Anthropic teams use Claude Code](https://www.anthropic.com/news/how-anthropic-teams-use-claude-code) - Examples from Anthropic teams
- [How we built our multi-agent research system](https://www.anthropic.com/engineering/built-multi-agent-research-system) - Anthropic engineering case study
