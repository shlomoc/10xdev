...
- [Gemini CLI: Code & Create with an Open-Source Agent](https://learn.deeplearning.ai/courses/gemini-cli-code-and-create-with-an-open-source-agent) Deeplearning.ai intro course
